...
\usepackage{subfig}
% Wird subfig benutzt, passen die referenz-Seiten nicht. Die Option behebt den Fehler.
...
%\acsetup{
%	make-links = true,				% erstelle link
%	first-style = long-short,		% darstellung der ersten benutzung
%	list/display = used,			% stelle nur benutzte dar
%	pages/display = all,			% zeige Seitenzahlen im abbildungsverzeichniss an
%}
...
\usepackage[
	...
	hidelinks, % Links schwarz darstellen
]{hyperref}
% ===========================================================================
% PDF-Optionen ende
% ===========================================================================
